...
import e2e from '/assests/SVGs/What We Do Icons/factory.svg'
import aggregation from '/assests/SVGs/What We Do Icons/food-donation.svg'
import commodity from '/assests/SVGs/What We Do Icons/market.svg'
  ...
  return (
    <>
      ...
      <main className="pt-[6.9rem] mb-0">
        <section
          className="grid md:grid-cols-2 mt-0 pt-[3.125em] pb-[4.8125em]"
          id="homeCaption"
        >
